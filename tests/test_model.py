...
@patch(
    "nfl_predictor.utils.helpers.get_injuries_adjustment"
)  # Mock injury adjustment logic
def test_prediction_pipeline_with_adjustments_param(
    ...
    ht_pred = (
        round(model.predict(df[df["Tm"] == "HomeTeam"][features])[0])
