...
class TestLambdaHandler:
    ...
    def test_successful_prediction_execution(self, mock_run_predictions, mock_s3, sample_s3_event, sample_context, sample_predictions):
    ...
    @patch('nfl_predictor.lambda_handler.s3')
    @patch('nfl_predictor.lambda_handler.run_predictions')
    def test_no_predictions_generated(self, mock_run_predictions, mock_s3, sample_s3_event, sample_context):
    ...
    @patch('nfl_predictor.lambda_handler.s3')
    @patch('nfl_predictor.lambda_handler.run_predictions')
    def test_prediction_exception_handling(self, mock_run_predictions, mock_s3, sample_s3_event, sample_context):
    ...
    @patch('nfl_predictor.lambda_handler.s3')
    @patch('nfl_predictor.lambda_handler.run_predictions')
    def test_s3_upload_error(self, mock_run_predictions, mock_s3, sample_s3_event, sample_context, sample_predictions):
    ...
    @patch('nfl_predictor.lambda_handler.s3')
    @patch('nfl_predictor.lambda_handler.run_predictions')
    def test_url_encoded_key_handling(self, mock_run_predictions, mock_s3, sample_context, sample_predictions):
    ...
    @patch('nfl_predictor.lambda_handler.s3')
    @patch('nfl_predictor.lambda_handler.run_predictions')
    @patch.dict(os.environ, {"INPUT_BUCKET": "custom-input", "OUTPUT_BUCKET": "custom-output"})
    def test_environment_variable_override(self, mock_run_predictions, mock_s3, sample_s3_event, sample_context, sample_predictions):
        ...
        assert upload_call_args[1] == "nfl-score-predictor-test-output"  # Should use the test bucket
